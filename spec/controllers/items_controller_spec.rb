...
describe ItemsController do
  ...
  describe "GET show" do
    it "assigns the requested item as @item" do
      item = Item.create! valid_attributes
      get :show, params: @params.merge(id: item), session: valid_session
  ...
  describe "GET edit" do
    it "assigns the requested item as @item" do
      item = Item.create! valid_attributes
      get :edit, params: @params.merge(id: item), session: valid_session
      assigns(:item).should eq(item)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Item" do
        expect {
          post :create, params: @params.merge(item: valid_attributes), session: valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved item as @item" do
        ...
        post :create, params: @params.merge(item: { "channel" => "invalid value" }), session: valid_session
        assigns(:item).should be_a_new(Item)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested item" do
        ...
        Item.any_instance.should_receive(:update_attributes).with(ActionController::Parameters.new("title" => "").permit!)
        put :update, params: @params.merge(id: item, item: { "title" => "" }), session: valid_session
      end

      it "assigns the requested item as @item" do
        item = Item.create! valid_attributes
        put :update, params: @params.merge(id: item, item: valid_attributes), session: valid_session
        assigns(:item).should eq(item)
      end
    ...
    describe "with invalid params" do
      it "assigns the item as @item" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Item.any_instance.stub(:save).and_return(false)
        put :update, params: @params.merge(id: item, item: { "channel" => "invalid value" }), session: valid_session
        assigns(:item).should eq(item)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested item" do
      item = Item.create! valid_attributes
      expect {
        delete :destroy, params: @params.merge(id: item), session: valid_session
      }.to change(Item, :count).by(-1)
    end
